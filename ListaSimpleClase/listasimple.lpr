...
begin
  ...
  if Eliminar(miLista, 11) then
   ...
   writeln('11 no fue eliminado porque no existe');

  if Eliminar(miLista, 44) then
   writeln('44 fue eliminado correctamente')
  else
   writeln('44 no fue eliminado porque no existe');
